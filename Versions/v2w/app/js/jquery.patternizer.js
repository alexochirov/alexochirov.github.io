(function ($) {
    ...
    function getFontSizeMeasurerValue() {
        return parseFloat(textBlocks[0].span.css("font-size")) + fontsizeMeasurer.height() + fontsizeMeasurer.width();
    }

    function buildMeasurer() {
        fontsizeMeasurer = $(document.createElementNS(NS.xhtml, "span"));

        fontsizeMeasurer.attr("id", fontsizeMeasurerId).attr("style", "display:inline;position:absolute;left:-10000px;bottom:0");
