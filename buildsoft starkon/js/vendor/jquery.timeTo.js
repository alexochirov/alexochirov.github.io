    ...
    $.fn.timeTo = function() {
        ...
        return this.each(function() {
            ...
            if (!data.vals || method === 'reset') { // new clock
                ...
                data.height = Math.round(data.fontSize * 100 / 93)-40 || data.height;
                data.width = Math.round(data.fontSize * 0.8 + data.height * 0.13)+4 || data.width;
