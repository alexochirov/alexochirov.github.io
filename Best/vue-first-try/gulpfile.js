...
const paths = {
    ...
    src: {
        ...
        jsLib: [
            ...
            'node_modules/@fortawesome/fontawesome-free-brands/index.js','node_modules/babel-polyfill/dist/polyfill.min.js','node_modules/vue/dist/vue.js','node_modules/vuetify/dist/vuetify.min.js'
        ],
    ...
    watch: {
        html: ['src/pug/**/*.pug','src/pug/**/*.html','src/blocks/**/*.pug'],
        js: ['src/js/**/*.js'],
        json: ['src/json/**/*.json'],
