...
gulp.task('inliner', ['sass'], function() {
...
gulp.task('watch', function() {
  gulp.watch(path.src.stylepack + '/**/*.scss', ['helper','inliner']);
  gulp.watch(path.src.html, ['inliner']);
...
gulp.task('default', function(callback) {
  runSequence(['browserSync', 'watch', 'helper', 'images', 'inliner'], //
    callback
  );
});
